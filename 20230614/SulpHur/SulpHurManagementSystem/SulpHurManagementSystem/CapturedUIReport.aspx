...
<head>
    ...
    var ceapexLink = 'https://ceapex.visualstudio.com/CEINTL/_workitems/edit/';
                    ...
                    for (var bugSummaryIndex = 0; bugSummaryIndex < bugSummary.length; bugSummaryIndex++) {
                        if (bugSummary[bugSummaryIndex].length > 0) {
                            ...
                            for (var item of bugSummary[bugSummaryIndex]) {
                                if (item.bug_id.toString().length <= 6)
                                    webLink = ceapexLink;
                                else
                                    webLink = msazureLink;
                                bugLink = bugLinkFormatString.format(webLink, item.bug_id, colorSetting[item.status]);

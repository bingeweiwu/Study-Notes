...
namespace SampleCodeDom
{
    ...
    class Sample
    {
        ...
        CodeTypeDeclaration targetClass1;

        /// <summary>
        /// The name of the file to contain the source code.
        /// </summary>
        private const string outputFileName = "SampleCode1.cs";
        ...
        public Sample()
        {
            ...
            targetUnit.ReferencedAssemblies.Add("System.IO");
            ...
            targetClass1 = new CodeTypeDeclaration("CodeDOMCreatedClass1");
            targetClass1.IsClass = true;
            targetClass1.TypeAttributes =
                TypeAttributes.Public | TypeAttributes.Sealed;

            targetClass.Members.Add(targetClass1);
            samples.Types.Add(targetClass);
            //samples.Types.Add(targetClass1);

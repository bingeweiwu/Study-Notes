...
<head>
    ...
    function DoQuery(pageIndex, flag) {
        ...
        if (showLatest && (SelectedRules == 'All' || SelectedRules.indexOf(',') != -1)) {
        ...
        if (flag == 0) {
            ...
            if (pageIndex == 0) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log("Succeeded to run GetTotalRecords");
...
<%--                        <div class="ShowMoreContainer ShowMoreAction">
        ...
        <div id="ConditionFilter">
            ...
            <input type="checkbox" id="showLatest"  value="Show Latest Build" name="showLatest" checked="checked" />Latest Result

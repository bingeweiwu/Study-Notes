...
WHERE[Results].[ResultID] IN({0})",
        ...
        GetDetailResultsOfSpecifiedPage(buildNOs, buildLans, osTypes, osLanguages, ruleIDs,
                resultTypes, assemblyNames, typeIDs, ReviewedStatus,  sortBy, searchDateTime,
                currentPageResults, 0, getLatest, latestDays)
         */
            ...
            string diffentReviewStatusResultsCount, bool getLatest, int latestDays,string pageIndex)
        {
            ...
            string sql = string.Empty;
           if (currentPageResults != "undefined" && true==false)
            {

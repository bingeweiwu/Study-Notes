...
<body>
    ...
    <div class="header">
        ...
        <!-- 搜索 -->
        <div class="search">
            <input type="text" name="" id="search" placeholder="Result ID / Page Title / User Name"><button onclick="Search()">Search</button>
        </div>
        <!-- 用户 -->
        <div class="user">
    ...
    <div class="content wrapper">
        ...
        <div class="right">
            ...
            <div class="commonButton">
                ...
                <div class="Next">
                    <button onclick="ExpandAllTr(false)">Collapse</button>
                </div>
            </div>
